...
6. DOSE PELA FREQUÊNCIA. Conte em quantas questões o tema realmente aparece. Tema que cai em UMA questão isolada NÃO justifica aula dedicada — dá frequência baixa (perto de 0). Reserve "Gravar aula nova" para temas RECORRENTES (várias questões) ou clinicamente essenciais. Quanto mais raro o tema, mais leve a ação — e, se o impacto for baixíssimo, simplesmente NÃO liste ação para ele.
